...
namespace Book_store.Service.Implementation
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(EmailMessage allMails)
        {
            ...
            {
                Sender = new MailboxAddress("Bookstore", "integrated_systems_finki@outlook.com"),
                Subject = allMails.Subject
            };

            emailMessage.From.Add(new MailboxAddress("Bookstore", "integrated_systems_finki@outlook.com"));
